...
public class CampTest1 {
	public CampTest1 () {	}//생성자
	public CampTest1 (String place, int year)
	{System.out.println(year+"년에 지어진 "+place);
		//기본생성자 생략 가능
		//생성자는 new 키워드 다음에 기술
		//생성자 void 타입 없어요
	}	//기본 생성자
	...
	CampTest1 ct = new CampTest1("남이섬 주말 캠프", 1997);
	//CampTest1 ct = new CampTest1("남이섬 주말 캠프");
	...
	while(true) {
		...
		case 1: 
			...
			else {System.out.println("camp["+num+"] 캠프장 예약성공");
